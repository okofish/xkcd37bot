...
var mode = "none"; // set to blacklist, whitelist, or none
...
var comment_stream = new RedditStream('comments', 'xkcd', 'bot/' + botName) // set the second argument to 'all' for blacklist/whitelist to function, or a single subreddit to only respond there. if you choose a single subreddit, make sure to set mode to none.
